 ...
 *
 * <p>Возвращает сущности, у которых значение поля меньше или равно заданному.</p>
 *
 * <p><b>Особенности:</b></p>
 * <ul>
...
public class LessThanOrEqualTo<E, C extends Comparable<? super C>>
    ...
    /**
     * Возвращает спецификацию "LESS THAN OR EQUAL TO" для JPA Criteria API.
     *
     * <p>Если {@code value} не {@code null}, создаётся предикат {@code lessThanOrEqualTo} по указанным полям.
     * В противном случае возвращается пустая спецификация {@link Empty}.</p>
     *
     * @return спецификация JPA Criteria API для условия lessThanOrEqualTo
     */
    @Override
